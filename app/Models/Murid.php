...
class Murid extends Model
{
   ...
   */
  protected $fillable = [
    'nis', 'nisn', 'nama', 'tempat_lahir', 'tanggal_lahir', 'jenis_kelamin', 'hobi', 'cita_cita', 'jumlah_saudara', 'alamat', 'id_provinsi', 'provinsi', 'id_kabkot', 'kabkot', 'id_kec', 'kecamatan', 'kode_pos', 'no_kk', 'nama_ayah', 'id_pendidikan_ayah', 'id_pekerjaan_ayah', 'nama_ibu', 'id_pendidikan_ibu', 'id_pekerjaan_ibu', 'status_murid', 'agama',
  ];
  ...
  public function nilai()
    {
        return $this->hasMany('App\Models\Nilai','id_murid','id');
    }
